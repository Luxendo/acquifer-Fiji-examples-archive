...
# We can get the list of images (ImagePlane objects) in this dataset instance then
IJ.log("\nSorted dataset")
listPlanes = dataset.getListImagePlanes()
print listPlanes[:2] # show only the first 2 ImagePlane
Utils.printArray(listPlanes)




#### Dimensions filtering #####
# We can also return only some images matching some dimensions of interest
