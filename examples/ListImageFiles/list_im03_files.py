"""
This jython script demonstrates how to list image files from an Imaging Machine (version 3 ie IM03) experiment directory.
...
"""
#@ File (label="Select an IM03 directory", style="directory") image_directory
